...
REM Stream 을 사용할 경우
REM java -jar ./dataflow/spring-cloud-dataflow-server-2.11.5.jar --spring.config.location=./dataflow/dataflow-server.yml --spring.cloud.skipper.client.serverUri=http://localhost:7577/api
