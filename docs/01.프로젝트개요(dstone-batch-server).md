...
## <span style="color:green;">1. 개요</span>
...
## <span style="color:green;">2. 주요 구성 요소</span>
...
## <span style="color:green;">3. 디렉토리 구조</span>
...
## <span style="color:green;">4. 실행 흐름</span>
...
## <span style="color:green;">5. Batch Applicaiton 등록</span>
...
## <span style="color:red;">6. 제약</span>
```txt
- dataflow(SCDF)의 경우 아래의 테이블이 소문자로 생성됨. 따라서 기존에 테이블이 이미 대문자로 생성되어 있다면 해당 테이블은 사용되지 않음.
  app_registration
  audit_records
  hibernate_sequence
  stream_definitions
  task_definitions
  task_deployment
- 2025-12-21 현재로서는 SCDF는 테이블명을 대문자로 “핸들링(변경/강제)”할 수 있는 공식 방법이 없음.
```
